...
<template>
  <div class="pl-4 pt-0 pb-2 d-flex align-center">
    ...
    <div class="d-inline">
      ...
      <!---------------------------- Measurement value ------------------------------->
      <div class="pl-3 d-flex align-baseline pt-1">
        <span class="font-weight-bold text-body-2 text-text"
          >{{ props.deviceMeasurementValue }}
        </span>
        <!---------------------------- Measurement unit ------------------------------->
        <span class="pl-1 text-caption text-mediumGray">
          {{
            (props.unit === 'mm' && props.measurementMetadata.measurement === 'Precip Rate') ||
            (props.unit === 'in' && props.measurementMetadata.measurement === 'Precip Rate')
              ? `${props.unit}/h`
              : `${props.unit}`
          }}
